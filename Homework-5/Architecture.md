...
Способы обеспечения требований по согласованности, доступности и производительности применяемые в системе описаны в разделах [Предлагаемая архитектура](#предлагаемая-архитектура), [Масштабируемость](#Масштабируемость), [Обеспечение высокой доступности и отказоустойчивости](#обеспечение-высокой-доступности-и-отказоустойчивости), [Оптимизация производительности](#оптимизация-производительности).

 ## Мониторинг и отладка

Метрики мониторинга системы телеметрии и инструменты для их анализа описаны в разделе [План мониторинга системы](#план-мониторинга-системы).